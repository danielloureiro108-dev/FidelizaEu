    ...
    <div className="mx-auto min-h-dvh max-w-md">
      ...
      <main className="px-5 pb-24">
        ...
        {rewards && rewards.length > 0 && (
          <div className="mt-5 rounded-card border-2 border-brand-secondary bg-brand-secondary/10 p-4">
            ...
            {rewards.map((r) => (
              <div
                key={r.id}
                className="mt-2 flex items-center justify-between rounded-lg bg-white px-3 py-2"
              >
      ...
      <div className="fixed inset-x-0 bottom-0 mx-auto max-w-md p-4">
        <Link
          href="/scan"
          className="flex items-center justify-center gap-2 rounded-full bg-brand-primary py-4 font-semibold text-white shadow-lg transition active:scale-[0.98]"
        >
